 ...
 * --------------------------------------------------------------------------
 * Modale de confirmation de suppression d'un trajet. Contrôlée en React
      ...
      >
        <div className="modal-content">
          <div className="modal-header">
            <h2 className="modal-title h5" id="delete-trip-title">
              Supprimer le trajet
            </h2>
          ...
          <div className="modal-body">
            ...
            <p id="delete-trip-description" className="mb-0">
              Voulez-vous vraiment supprimer le trajet <strong>{trip.tripNumber}</strong>&nbsp;? Cette action
              est irréversible.
            </p>
          </div>
